...
- 🏅 *잡케어 추천 알고리즘 경진대회* - *Encouragement Award(장려상)* **(4/1,627)**
- 🏅 *음향 데이터 COVID-19 검출 AI 경진대회* - **1st placed (1/696) 및 상금 후원(세이브더칠드런)**
- 🏅 *건설기계 오일 상태 분류 AI 경진대회* - *Excellence Award(우수상)* **(4/1,322)**
- 🏅 *[Space-S x KaKR] 그래프 러닝 및 해커톤* - *Code Sharing Award(코드 공유상)*
- 🏅 *Synthetic AKI data Challenge 2023* - *Excellence Award(우수상)* **(2/67)**
